            ...
            <tbody>
                ...
                <tr><!-- CONTENIDO TITULAR -->
                    <td style="display: block; padding: 5px 15px;">
                       <p style="font-size:12px;">Hola <strong style="text-transform: uppercase">{{ $name }}</strong>, se ha creado el convenio correctamente, bajo lo estipulado en el contrato.</p>
                       <p style="font-size:12px;">Para iniciar sesión en la cuenta de CitasMedicas, haz click en el botón "Iniciar Sesión", ubicado en la parte superior derecha de la página e introduce tu usuario y contraseña o <a href="{{ route('login') }}">dando click aqui</a></p>
                       <p style="font-size:12px;">Datos de Acceso:</p>
                    </td>
                 </tr>
                 <tr><!-- CONTENIDO -->
                    <td style="display: block; padding: 5px 15px;">
                ...
                <tr><!-- CONTENIDO TITULAR -->
                    <td style="display: block; padding: 5px 15px;">
                       <p style="font-size:12px;">Detalles del convenio registrado: </p>
                    </td>
                 </tr>
                ...
                <tr><!-- CONTENIDO -->
                    <td style="display: block; padding: 5px 15px;">
                       <table width="100%" border="0" class="css_table_secondary">
                         <tbody>
                             <tr style="border-bottom: 1px solid #ddd; vertical-align: top;">
                                <th width="30%" class="css_table_secondary_body_th">Nombre de Contácto:</th>
                                <td width="70%" class="css_table_secondary_body_td">{{ $name_contact }}</td>
                             </tr>
                             <tr style="border-bottom: 1px solid #ddd; vertical-align: top;">
                                <th width="30%" class="css_table_secondary_body_th">Teléfono de Contácto:</th>
                                <td width="70%" class="css_table_secondary_body_td">{{ $num_phone_contact }}</td>
                             </tr>
                             <tr style="border-bottom: 1px solid #ddd; vertical-align: top;">
                                <th width="30%" class="css_table_secondary_body_th">Fecha y Hora de registro:</th>
                                <td width="70%" class="css_table_secondary_body_td">{{ $fechaconvenio }}</td>
                             </tr>
                          </tbody>
                       </table>
                    </td>
