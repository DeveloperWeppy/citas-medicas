            ...
            <tbody>
                ...
                <tr><!-- CONTENIDO TITULAR -->
                    <td style="display: block; padding: 5px 15px;">
                       <p style="font-size:12px;">Nuevo mensaje enviado desde el formulario de contácto del sitio web.</p>
                    </td>
                    <td style="display: block; padding: 5px 15px;">
                        <p style="font-size:12px; text-align: justify"><strong style="text-transform: uppercase">Mensaje:</strong> {{ $message }}</p>
                     </td>
                     <td style="display: block; padding: 5px 15px;">
                        <p style="font-size:12px;">Información de la persona que ha enviado el mensaje:</p>
                     </td>
                 </tr>
                 <tr><!-- CONTENIDO -->
                    <td style="display: block; padding: 5px 15px;">
                       <table width="100%" border="0" class="css_table_secondary">
                         <tbody>
                             <tr style="border-bottom: 1px solid #ddd; vertical-align: top;">
                                <th width="30%" class="css_table_secondary_body_th">Nombres:</th>
                                <td width="70%" class="css_table_secondary_body_td">{{ $nombres }}</td>
                             </tr>
                             <tr style="border-bottom: 1px solid #ddd; vertical-align: top;">
                             ...
                             <tr style="border-bottom: 1px solid #ddd; vertical-align: top;">
                                ...
                                <td width="70%" class="css_table_secondary_body_td">{{ $mailcontact }}</td>
                             </tr>
                          </tbody>
                       </table>
                    </td>
